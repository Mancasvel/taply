...
export const metadata: Metadata = {
  title: 'Términos y Condiciones | Taply',
  description: 'Términos y condiciones de uso de Taply. Información legal sobre el uso de nuestra plataforma de tarjetas digitales.',
}
