...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-taply-gray-dark border-t border-gray-800 py-12 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-taply-blue transition-colors duration-300 text-sm">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-12 h-12 bg-taply-dark border border-gray-700 rounded-full flex items-center justify-center hover:border-taply-blue hover:bg-taply-blue/10 transition-all duration-300"
              >
